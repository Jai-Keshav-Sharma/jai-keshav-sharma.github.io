...
You've seen the `temperature` parameter everywhere. In the OpenAI playground. In every "how to use GPT" tutorial. In whatever prompt engineering course you mindlessly bookmarked last month.
